...
Gem::Specification.new do |s|
  ...
  s.authors = ["Ahmed Adam", "Alex Wayne", "Andrew White", "Duccio", "JJ Buckley", "Jason Lee", "Joshua Abbott", "Koji Ando", "Kouhei Sutou", "Lasse Jansen", "Lo\303\257c Guitaut", "Martin Vielsmaier", "Squeegy", "Vannoy", "josei", "ralph"]
  s.date = %q{2010-12-07}
